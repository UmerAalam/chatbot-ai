...
function AnswerPrompt(props: { answer?: string }) {
  return (
    <div className="mr-auto w-full max-w-[75%] bg-gray-700/20 text-white/90 font-semibold flex justify-start z-0 items-start border-l-8 border-white/80 pl-3 pr-5 py-3 mt-3 h-auto min-h-12 rounded-2xl backdrop-blur-sm">
