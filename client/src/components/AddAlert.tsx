...
const AddAlert = ({ addBtn, cancelBtn, isChat = false }: Props) => {
  ...
  return (
    <div className="absolute z-10 top-0 left-0 bg-black/50 w-fit h-screen flex items-center justify-center backdrop-blur-2xl">
      <div className="flex flex-col gap-5 scale-80 items-center justify-center bg-gray-800/20 border-2 border-transparent hover:border-gray-500/50 w-100 h-50 rounded-2xl">
